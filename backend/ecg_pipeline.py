...
def preprocess_ecg(file_bytes: bytes) -> dict:
    ...
    return preprocess_ecg_signal(raw)


def preprocess_ecg_signal(raw_signal: np.ndarray) -> dict:
    """
    Variante du pipeline de pretraitement pour un signal deja decode/extrait.
    Retourne les features extraites.
    """
    raw = _normalize_ecg_units(raw_signal)
